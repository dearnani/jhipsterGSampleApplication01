...
@EnableZuulProxy
public class JhipsterGSampleApplication01App {

    private static final Logger log = LoggerFactory.getLogger(JhipsterGSampleApplication01App.class);

    private final Environment env;

    public JhipsterGSampleApplication01App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterGSampleApplication01.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterGSampleApplication01App.class);
